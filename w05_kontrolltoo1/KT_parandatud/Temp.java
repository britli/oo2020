...
public class Temp {
    ...
    public static void main(String[] args) throws IOException{
        ...
        for(int i = 0; i < temps.size(); i++){
            ...
            kesk = (Double.parseDouble(lineContent[1])/ 2 +  Double.parseDouble(lineContent[5])/ 2 +  Double.parseDouble(lineContent[2]) + Double.parseDouble(lineContent[3])+  Double.parseDouble(lineContent[4])) / 5/*see on antud et igal päeval mõõdeti 5 korda temperatuuri */ ;
